...
%5dB => seuil 0.35*10e4 %on peut pas prendre trop bas sinon dégueu
%10dB => seuil 0.20*10e4
%15dB => seuil 0.13*10e4
...
plot(val_sing_ligne);
title('VS d une trame du signal');
xlabel('Echantillons d une trame');
ylabel('Valeur des VS');
...
xlabel('Trames du signal');
ylabel('Valeur des VS');
legend('VS des trames','seuil defini');
...
legend('trame sans bruit','trame',' trame rehaussee');

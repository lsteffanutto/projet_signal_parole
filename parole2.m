...
fech = 8000;
Tech=1/fech;
t = 0:Tech:len_sig1*Tech-Tech;

sig1_sans_bruit = sig1;
trame_sans_bruit = sig1(1029 : 1029+512);
...
%audiowrite('musique1.wav',sig1_sans_bruit,8000) %ECRIT LE SIGNAL DANS FICHIER AUDIO
%audiowrite('musique1.wav',sig1,8000) %ECRIT LE SIGNAL DANS FICHIER AUDIO
%audiowrite('musique2.wav',signal_final,8000) %ECRIT LE SIGNAL DANS FICHIER AUDIO
